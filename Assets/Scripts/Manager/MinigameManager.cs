...
public class MinigameManager : MonoBehaviour
{
    ...
    public MinigameMashClick CurrentlyActiveMinigame { get; private set; }
    ...
    public void StartMashClickMinigame(MinigameMashClick sourceBlock, Vector3 position, float maxGauge)
    {
        // 이미 미니게임 UI가 켜져 있다면 중복 실행 방지
        if (currentUiInstance != null) return;
        CurrentlyActiveMinigame = sourceBlock;
